  ...
  return (
    <>
      ...
      <Modal open={open} onClose={handleClose}>
        <div className="relative overflow-y-auto max-h-[90vh] flex sm:flex-row xs:flex-col gap-5 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 xs:w-[300px] s:w-[500px] sm:w-[700px] md:w-[800px] lg:w-[900px] xl:w-[1000px] bg-grey-0 shadow-lg xs:p-4 sm:p-8 rounded-lg">
